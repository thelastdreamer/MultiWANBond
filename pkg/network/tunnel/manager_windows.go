...
// WindowsManager implements tunnel management for Windows
type WindowsManager struct{}

// newWindowsManager creates a new Windows tunnel manager
func newWindowsManager() (Manager, error) {
	return &WindowsManager{}, nil
}

// Create creates a new tunnel
func (m *WindowsManager) Create(config *TunnelConfig) error {
...
func (m *WindowsManager) Get(name string) (*TunnelInfo, error) {
	return nil, &TunnelError{Op: "Get", Tunnel: name, Err: ErrNotSupported}
}

// List returns all tunnels
func (m *WindowsManager) List() ([]*TunnelInfo, error) {
...
func (m *WindowsManager) Update(config *TunnelConfig) error {
...
func (m *WindowsManager) RemoveWireGuardPeer(tunnelName, publicKey string) error {
...
func (m *WindowsManager) GetWireGuardPeers(tunnelName string) ([]WireGuardPeerInfo, error) {
...
func (m *WindowsManager) SetWireGuardPrivateKey(tunnelName, privateKey string) error {
...
func (m *WindowsManager) SetWireGuardListenPort(tunnelName string, port int) error {
...
func (m *WindowsManager) SetGREKey(tunnelName string, key uint32) error {
...
func (m *WindowsManager) SetGREChecksum(tunnelName string, enabled bool) error {
...
func (m *WindowsManager) SetGRESeq(tunnelName string, enabled bool) error {
